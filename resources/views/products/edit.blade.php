...
<div class="max-w-2xl mx-auto">
  ...
  <form action="{{ route('products.update', $product) }}" method="POST" class="bg-white p-6 rounded shadow">
    ...
    <div class="mb-4">
      ...
      <input id="name" name="name" type="text" value="{{ old('name', $product->name) }}" maxlength="100"
    ...
    <div class="mb-4">
      ...
      <textarea id="description" name="description" rows="4" class="w-full border rounded p-2 @error('description') border-red-500 @enderror">{{ old('description', $product->description) }}</textarea>
